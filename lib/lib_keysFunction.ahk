...
keyFunc_CommentBlock(){
    SendInput,^{4}
    return
}

keyFunc_CommentBlock_cancel(){
    SendInput,^{5}
    return
}
...
keyFunc_AddCellLabel(){
    SendInput,{enter}{Text}# In[]
    return
}

keyFunc_CloseProcess(){
    SendInput,!{F4}
    return
}
...
keyFunc_LastTab(i:=1){
    ; SendInput,{Ctrl down}{Shift down}{Tab %i%}
    keypress2 := 0
    Loop
    {
        if GetKeyState("CapsLock","P")
        {
            if (GetKeyState("w","P") and  keypress2=0)
            {
            ...
            if (!GetKeyState("w","P") and  keypress2=1)
            {
                keypress2 := 0
            }       
            if (GetKeyState("s","P") )
...
keyFunc_NextTab(i:=1){
    ...
    Loop
    {
        if GetKeyState("CapsLock","P")
        {
            if (GetKeyState("s","P") and  keypress=0)
            {
            ...
            if (!GetKeyState("s","P") and  keypress=1)
            {
                keypress := 0
            }    
            if (GetKeyState("w","P") )
...
keyFunc_WheelDown(i:=1){
    SendInput,{WheelDown %i%}
    Return
}
...
keyFunc_mouseLeftKey(){
    SendInput,{Click Left}
    Return
}

keyFunc_Shift_mouseLeftKey(){
    SendInput,+{Click Left}
    Return
}

keyFunc_mouseRightKey(){
    SendInput,{Click Right}
    Return
}

keyFunc_mouseMiddleKey(){
    SendInput,{MButton}
    Return
}
